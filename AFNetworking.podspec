Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/hcdself/AFNetworking.git'
  s.social_media_url = 'https://github.com/hcdself/AFNetworking.git'
  s.authors  = { 'hcdself' => '1332971097@qq.com' }
  s.source   = { :git => 'https://github.com/hcdself/AFNetworking.git', :tag => s.version }
  ...
  s.resource_bundle = { 'AFNetworking' => ['PrivacyInfo.xcprivacy'] }
